...
public class BookController {
	...
	public ResponseEntity<?> addNewBook(@RequestBody @Valid BookDTO newBook,@RequestParam("imageFile") MultipartFile imageFile) {
		try {
			return new ResponseEntity<>(bookService.addNewBook(newBook,imageFile), HttpStatus.CREATED);
		} catch (IOException e) {

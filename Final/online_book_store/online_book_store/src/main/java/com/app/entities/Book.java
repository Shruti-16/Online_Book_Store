...
//	private Order order; // Represents the order this book belongs to
	...
	public Book(Long bookId, String bookImage, String title, List<Language> languages, LocalDate publicationDate,
			String author, int edition, boolean isAvailable, int stock, Genre genre, List<Review> reviews,
			List<Cart> carts, float markedPrice, float sellingPrice, String description) {
		super();
		this.bookId = bookId;

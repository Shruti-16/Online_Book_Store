...
public class ResponseBookDTO {
	...
	public ResponseBookDTO(Long bookId,
			...
			@NotBlank @Length(max = 15, min = 3, message = "Author Name should be between 3 to 15 characters.") String author,
			...
			@Min(value = 1, message = "Stock should be greater than 1") int stock, String genre, List<String> reviews) {
		super();
		this.title = title;

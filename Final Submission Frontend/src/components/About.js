      ...
      <div className="container-fluid about-us">
        <div className="row align-items-center justify-content-evenly">
          <div className="col-4 align-self-center p-5 rounded  ">
            ...
            <p><b>Book Shopping</b> is an activity in which a customer browses the available books presented by one or more retailers with the potential intent to purchase a suitable book for them. A typology of shopper types has been developed by

                    ...
                    <form onSubmit={handleAddProduct} style={{ color: "white" }}>
                        ...
                        <span className="row g-3 mb-3">
                            <div className="col-md-6">
                                ...
                                <div>
                                    <input className="form-control" type="text" placeholder="Available/Out of Stock" value={sellingPrice} onChange={(event) => setProductName(event.target.value)} required></input>
                                </div>
                            </div>
                            <div className="col-md-6">

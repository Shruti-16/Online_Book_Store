...
function UpdateUser() {
    ...
    useEffect(() => {
        // Fetch user data based on the location state, route params, or any other mechanism
        const userData = fetchUserData(); // Implement this function to fetch user data
        setUser(userData);

        // Disable updating first name and last name
    ...
    const updateUser = (event) => {
        ...
        // Call your update user service here with updatedUserData

        // Example using a hypothetical service function
        updateUserService(updatedUserData)
            .then((result) => {

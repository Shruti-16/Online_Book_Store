...
function UpdateUser() {
    ...
    const handleRegister = (event) => {
        ...
        LoginServiceCustomer.UpdateUser(firstName, lastName, email, password, confirmPassword, dateOfBirth, addressLine1, addressLine2, city, phoneNumber, registeredDate).then((result) => {
                        ...
                        <form onSubmit={handleRegister}>
                            <span className="row g-3 mb-2">
                                <div className="col-md-6">
                                    ...
                                    <div className="">
                                        <input className="form-control " type="text" disabled={true} placeholder="First Name" value={firstName} onChange={(event) => setFirstName(event.target.value)} required></input>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="">
                                        <input className="form-control " disabled={true} type="text" placeholder="Last Name" value={lastName} onChange={(event) => setLastName(event.target.value)} required></input>
                                    </div>
                                </div>
                            ...
                            <span className="row g-3 mb-2">
                                <div className="col-md-6">
                                    ...
                                    <div className="">
                                        <input className="form-control " disabled={true} type="email" placeholder="abc@gmail.com" value={email} onChange={(event) => setEmail(event.target.value)} required></input>
                                    </div>
                                </div>
                            ...
                            <span className="row g-3 mb-2">
                                ...
                                <div className="col-md-6 ">
                                    ...
                                    <div className="">
                                        <input className="form-control " disabled={true} type="date" value={dateOfBirth} onChange={(event) => setDateOfBirth(event.target.value)} required></input>
                                    </div>
                                </div>
                            ...
                            <span className="row g-3 mb-2">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input type="date" className="form-control " disabled={true} value={registeredDate} onChange={(event) => setRegisteredDate(event.target.value)}></input>
                                    <div className="valid-feedback">
